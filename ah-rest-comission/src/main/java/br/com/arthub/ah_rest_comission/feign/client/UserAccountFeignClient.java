package br.com.arthub.ah_rest_comission.feign.client;
...
import br.com.arthub.ah_rest_comission.config.FeignClientConfig;
...
public interface UserAccountFeignClient {
	 ...
	 * <p>Esse endpoint é protegido com uma senha para que apenas esse microserviço possa chama-lo.</p>
	 * */
	@GetMapping("/v1/getArtistIdByToken")
	ResponseEntity<ApiResponse> getArtistIdByToken(@RequestParam(name = "tokenJwt", required = true) String token,
			@RequestParam(name = "secret", required = true) String secret);
